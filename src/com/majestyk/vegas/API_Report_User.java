...
public class API_Report_User extends AsyncTask<String, Void, String> {

	Context c;
	OnTaskCompleteListener complete;
	ProgressDialog dialog;
	
	public API_Report_User (Context c, OnTaskCompleteListener complete) {
		this.c = c;
	...
	protected String doInBackground(String... params) {
		...
		HttpPost httppost = new HttpPost(String.format(GlobalValues.Service_URL + "%s", "/complaint/add"));
		...
		try {
			...
			if (entity != null) {
				...
				Log.i("Report", "/user/report: " + result);
			}
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void onPostExecute(String result) {
		...
		try {
			...
			if(jObject.has("complaint_id")) {
				Toast.makeText(c, "Report has been submitted", Toast.LENGTH_SHORT).show();
