 ...
 */
public class SemiOpened_SlidingDrawer extends ViewGroup {
	 ...
	 */
	public SemiOpened_SlidingDrawer(Context context, AttributeSet attrs)
	{
	 ...
	 */
	public SemiOpened_SlidingDrawer(Context context, AttributeSet attrs, int defStyle)
	{
